            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-800/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] transition hover:scale-101 rounded-lg p-6 backdrop-blur-sm border border-gray-700">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-around items-center gap-4">
                            ...
                            <div className="flex items-center justify-center sm:justify-end w-full sm:w-auto">
                                <a href="https://www.schildersbedrijf-arnedo.nl" className="bg-blue-500 text-white h-8 px-4 rounded font-medium transition inline-flex items-center relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]">Visit Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800/50 transition hover:scale-101 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] rounded-lg p-6 backdrop-blur-sm border border-gray-700">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-around items-center gap-4">
                            ...
                            <div className="flex items-center justify-center sm:justify-end w-full sm:w-auto">
                                <a href="https://damoschildersbedrijf.nl/" className="bg-blue-500 text-white h-8 px-4 rounded font-medium transition inline-flex items-center relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]">Visit Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800/50 transition hover:scale-101 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] rounded-lg p-6 backdrop-blur-sm border border-gray-700">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-around items-center gap-4">
                            ...
                            <div className="flex items-center justify-center sm:justify-end w-full sm:w-auto">
                                <a href="https://arnedoschildersbedrijf.nl/" className="bg-blue-500 text-white h-8 px-4 rounded font-medium transition inline-flex items-center relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]">Visit Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800/50 transition hover:scale-101 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] rounded-lg p-6 backdrop-blur-sm border border-gray-700">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-around items-center gap-4">
                            ...
                            <div className="flex items-center justify-center sm:justify-end w-full sm:w-auto">
                                <a href="https://currency-0d338f3b7007.herokuapp.com/" className="bg-blue-500 text-white h-8 px-4 rounded font-medium transition inline-flex items-center relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]">Visit Website</a>
                            </div>
                        </div>
                    </div>
